...
var CollaborationControlCapability = CapabilityDescriptor{
	CapabilityId: "collaboration.control", Version: "3.0",
	Actions: []string{
		...
		"inbox", "resolve", "decision_batch", "analysis_prepare", "result_recover", "validation_claim", "validation_receipt", "record_check", "tree", "tree_update", "archive", "retry", "upgrade",
	},
}
