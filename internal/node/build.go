...
func (c *Client) buildControl(ctx context.Context, params map[string]any) (buildControlResult, error) {
	...
	job, err := c.jobs.StartShell(cwd, input.Argv, timeout, input.IdempotencyKey)
	if err != nil {
		return buildControlResult{}, err
	}
