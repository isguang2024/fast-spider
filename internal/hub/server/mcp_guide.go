...
var mcpToolGuides = map[string]mcpToolGuideEntry{
	...
	"build_control": {
		Description: "Start a bounded build/test argv; returns jobId for job_watch.",
	...
	"browser_control": {
		Description: "Automate isolated Chromium via readiness/session/page/snapshot refs; screenshots return temporary URL metadata.",
