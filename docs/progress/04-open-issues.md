...
- `FS-0418-001..011`：OAuth 历史保留/Owner 隔离/DCR 来源、Presentation/Artifact 可恢复清理、Release manifest/staging 生命周期、秘密门禁、Codex/Job 关闭代际、Browser/组件持续清理、0.4.18 full gate 与生产发布均 PASS。
